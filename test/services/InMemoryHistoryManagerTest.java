...
class InMemoryHistoryManagerTest {
    ...
    void shouldKeepOldTaskVersions() {
        ...
        assertNotEquals(task.getTitle(), oldTask.getTitle());
        assertNotEquals(task.getDescription(), oldTask.getDescription());
        assertNotEquals(task.getTaskStatus(), oldTask.getTaskStatus());
    ...
    void shouldRemoveExistingTaskWhenAddingTaskAgain() {
        ...
        assertNotEquals(firstTitle, task.getTitle());
        assertNotEquals(firstDescription, task.getDescription());
        assertNotEquals(firstStatus, task.getTaskStatus());
